...
<?php 
      ...
      foreach($history as $row){
        ...
        echo "<tr><td>".$row['date']."</td><td>".$row['time_in']."</td><td>".$result['name']."</td><td>".$row['from_loc']."</td><td>".$row['to_loc']."</td><td>"."<a style = 'color: blue;' href='driver_writecomplaint.php'>Write complaint</a> </td></tr>";
