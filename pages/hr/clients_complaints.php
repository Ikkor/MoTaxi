...
<?php 
			...
			$stmt=$pdo->prepare('select * from client_complaints inner join user on id=user_id where status="notResolved" order by date');
			$stmt->execute();
			...
			foreach($details as $row){
				...
				<td>".$row['date']."</td>
				<td>".$row['status']."</td>
				<td>"."<a style = 'color:green;' href='resolveclientComplaint.php?id=".$row['complaint_id']."'>Change to resolved</a></td>
				</tr>";
