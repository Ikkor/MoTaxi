...
<?php 
      ...
      */
      ...
      $stmt=$pdo->prepare('select * from rides where client_id=:id order by time_in desc');
      $stmt->execute(['id'=>$id]);
      ...
      foreach($history as $row){
        ...
        echo "<tr><td><img src='".$pfplink."' border=3 height=100 width=100></img>"."</td><td>".$row['time_in']."</td><td>".$result['name']."</td><td>".$row['from_loc']."</td><td>".$row['to_loc']."</td><td>"."<a style = 'color:blue;'href='client_complaints.php?rideInQuestion=$ride_id'>Write complaint</a> </td></tr>";
