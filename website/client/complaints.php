		...
		<?php 
			...
			*/
			...
			foreach($history as $row){
				...
				echo "<tr><td><img src='".$pfplink."' border=3 height=100 width=100></img>"."</td><td>".$row['date']."</td><td>".$row['time_in'].$result['name']."</td><td>".$row['from_loc']."</td><td>".$row['to_loc']."</td><td>"."<a href='writecomplaint.php'>Write complaint</a> </td></tr>";

				$_SESSION['locationInQuestion']=$row['from_loc'];
				$_SESSION['dateInQuestion']=$row['date'];
				$_SESSION['driverInQuestion']=$driver_id;
