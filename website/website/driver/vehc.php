	...
	<table>
		...
		<?php 
			...
			foreach($listvehc as $row){
				...
				echo "<tr><td><img src='".$piclink."' border=3 height=100 width=100></img>"."</td><td>".$row['reg_no']."</td><td>".$row['s_type'].$row['seat']."</td><td>".$row['model_name']."</td><td>".$row['year'].$row['ac'].$row['boot_capacity']."</td><td>"."</td><td>"."</td><td>"."<a href='editvehc.php'>Edit Vehicule</a> </td></tr>";
